...
const responseConfigJSON = {
  headers: {
    ...
    'source-code': 'https://github.com/perryrh0dan/play-stats',
...
function handleIndex (url) {
  ...
  return template('https://perryrh0dan.github.io/play-stats/index.html', templateVars)
}
...
async function handleRequest (request, event) {
  ...
  if (url.pathname.startsWith('/play')) {
    ...
    return Response.redirect('https://perryrh0dan.github.io/play-stats/favicon.ico', 301)
  } else {
